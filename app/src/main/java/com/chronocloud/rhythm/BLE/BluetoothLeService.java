...
import com.chronocloud.rhythm.RhythmMmBp.AuthRequest;
import com.chronocloud.rhythm.RhythmMmBp.InitRequest;
...
public class BluetoothLeService extends Service implements Serializable {
    ...
    public static BluetoothLeService mmBluetoothLeService;
    ...
    private byte[] dataSnap; // 用来接收所有蓝牙发送的数据
    ...
    public void WriteValue(String strValue) {
        try {
            ...
            Toast.makeText(getApplicationContext(), "设备异常", 0).show();
        }
    }
    ...
    int iii = 0;
    StringBuffer abfd = new StringBuffer();
    ...
    public static BluetoothLeService get() {
